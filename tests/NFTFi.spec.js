...
describe('NFTFi', () => {
    ...
    describe("#NFTFiProjects", async () => {
        it("should return an array of projects", async () => {
            projects = await (0, utils_1.NFTFiProjects)();
    ...
    describe("#NFTFiTotalListings", async () => {
        ...
        before(async () => {
            listings = await (0, utils_1.NFTFiTotalListings)();
        });
    ...
    describe("#NFTFiListingsForProject", async () => {
        ...
        it("Should return the listings for a given address", async () => {
            projectListings = await (0, utils_1.NFTFiListingsForProject)(listings[0]._id);
        ...
        it("Should paginate the listings for a given address given a skip amount", async () => {
            ...
            let secondPage = await (0, utils_1.NFTFiListingsForProject)(listings[0]._id, SKIP);
    ...
    describe("#AllNFTFiListingsForProject", async () => {
        it("Should return all listings for a given address", async () => {
            allListings = await (0, utils_1.AllNFTFiListingsForProject)(listings[0]._id, listings[0].count);
